...
pathstem = '/imaging/mlr/users/tc02/vespa/preprocess/';
...
% group(cnt) = 2;
% 
% %THIS IS VC5, ERROR IN SAVING MEANS raw data is in file no_name!!!
% cnt = cnt + 1;
...
% group(cnt) = 2;
% 
% %%THIS IS VP12, ERROR IN SAVING MEANS raw data is in file no_name!!!
% cnt = cnt + 1;
...
% dates{cnt} = '140508';
% blocksin{cnt} = {'vespa_first', 'vespa_second','vespa_third'}; % NB: vespa_first is actually the average file, erroneously named
% blocksout{cnt} = {'run1', 'run2','run3'};
