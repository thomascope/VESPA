...
if multi,
    if analysismode == 1
        ...
        figure
        set(gcf,'position',[100,100,1200,800])
        barweb(meansarray,stesarray,[],{'4 channels';'8 channels';'16 channels'},['Clarity Ratings by Prime Type and Vocoder Channels for All Patients '],[],'Mean Clarity Rating',[],[],{'Match','Mismatch'}) ;
        legend('Match','Mismatch','location','NorthWest');
        ...
        saveas(gcf,[DIRS.dataFigs 'MEG Rating All Patients.jpeg'])
        ...
        figure
        set(gcf,'position',[100,100,1200,800])
        barweb(meansarray,stesarray,[],{'4 channels';'8 channels';'16 channels'},['Clarity Ratings by Prime Type and Vocoder Channels for All Controls '],[],'Mean Clarity Rating',[],[],{'Match','Mismatch'}) ;
        legend('Match','Mismatch','location','NorthWest');
        ...
        saveas(gcf,[DIRS.dataFigs 'MEG Rating All Controls.jpeg'])
        ...
        for i = 1:size(allmeansarray,1)
            allmeansarray(i,:) = [condat.meansarray(i,1), patdat.meansarray(i,1), condat.meansarray(i,2), patdat.meansarray(i,2)];
            allstesarray(i,:) = [condat.stesarray(i,1), patdat.stesarray(i,1), condat.stesarray(i,2), patdat.stesarray(i,2)];
        end
        
        figure
        set(gcf,'position',[100,100,1200,800])
        barweb(allmeansarray,allstesarray,[],{'4 channels';'8 channels';'16 channels'},['Clarity Ratings by Prime Type and Vocoder Channels for All Subjects '],[],'Mean Clarity Rating',[],[],{'ControlMatch','PatientMatch','ControlMismatch','PatientMismatch'}) ;
        legend('ControlMatch','PatientMatch','ControlMismatch','PatientMismatch','location','NorthWest');
        saveas(gcf,[DIRS.dataFigs 'MEG Rating All subjects.jpeg'])
        ...
        firstlegend = legend('Match','Mismatch','location','NorthWest');
        ...
        secondlegend = legend('Match','Mismatch','location','NorthWest');
        set(secondlegend,'FontSize',18);
        title('Patients','Color','k','fontsize',20)
        ylabel('Clarity Rating')
        xlabel('Vocode Channels')
        img = getframe(gcf);
        imwrite(img.cdata, [DIRS.dataFigs 'MEG Rating Linegraphs.jpeg']);
