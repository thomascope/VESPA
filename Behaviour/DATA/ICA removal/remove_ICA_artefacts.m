...
elseif length(FiltPars) == 2
    ...
    refs = ft_preproc_lowpassfilter(refs, FiltPars(2), FiltPars(1),  5, 'but','twopass','reduce')';
    ICs  = ft_preproc_lowpassfilter(activations,  FiltPars(2), FiltPars(1),  5, 'but','twopass','reduce')';
else
