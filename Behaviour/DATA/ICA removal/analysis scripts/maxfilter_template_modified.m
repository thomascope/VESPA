...
% cnt = 1;
% subject{cnt} = {'meg14_0072_vc1', '140224'};
% blocksin{cnt} = {'rest'};   % as named during recording, in /megdata/cbu/YourSubDir/... (may differ across subjects)
% blocksout{cnt} = {'run1'};      % should be consistent for all subjects
% badchannels{cnt, 1} = {'2141', '1731', '1412', '0813', '1611'}; badchannels{cnt, 2} = {'2141', '1731', '1412', '0813', '1611'}; badchannels{cnt, 3} = {'2141', '1731', '1412', '0813', '1611'}; badchannels{cnt, 4} = {''}; % define bad MEG (not EEG) channels here (if there are any)
% cnt=cnt+1;

cnt = 1;
subject{cnt} = {'meg14_0072_vc1', '140224'};
blocksin{cnt} = {'vespa_first', 'vespa_second', 'vespa_third'};   % as named during recording, in /megdata/cbu/YourSubDir/... (may differ across subjects)
blocksout{cnt} = {'run1', 'run2', 'run3'};      % should be consistent for all subjects
badchannels{cnt, 1} = {'2141', '1731', '1412', '0813', '1611'}; badchannels{cnt, 2} = {'2141', '1731', '1412', '0813', '1611'}; badchannels{cnt, 3} = {'2141', '1731', '1412', '0813', '1611'}; badchannels{cnt, 4} = {''}; % define bad MEG (not EEG) channels here (if there are any)
cnt=cnt+1;

subject{cnt} = {'meg14_0085_vp1', '140228'};
blocksin{cnt} = {'vespa_first', 'vespa_second'};
blocksout{cnt} = {'run1', 'run2'};
badchannels{cnt, 1} = {'0933', '1721', '1731', '1412', '0813'}; badchannels{cnt, 2} = {'0933', '1721', '1731', '1412', '0813'}; badchannels{cnt, 3} = {''}; badchannels{cnt, 4} = {''}; badchannels{cnt, 5} = {''}; badchannels{cnt, 6} = {''}; badchannels{cnt, 7} = {''}; % define bad MEG (not EEG) channels here (if there are any)
cnt=cnt+1;

subject{cnt} = {'meg14_0087_vp2', '140303'};
blocksin{cnt} = {'vespa_first' 'vespa_second' 'vespa_third'};   % as named during recording, in /megdata/cbu/YourSubDir/... (may differ across subjects)
blocksout{cnt} = {'run1' 'run2' 'run3'};      % should be consistent for all subjects
badchannels{cnt, 1} = {'0933', '1731', '0813'}; badchannels{cnt, 2} = {'0933', '1731', '0813'}; badchannels{cnt, 3} = {'0933', '1731', '0813'}; badchannels{cnt, 4} = {''}; badchannels{cnt, 5} = {''}; badchannels{cnt, 6} = {''}; badchannels{cnt, 7} = {''}; % define bad MEG (not EEG) channels here (if there are any)
cnt=cnt+1;
