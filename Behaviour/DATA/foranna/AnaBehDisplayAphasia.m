...
%
% -cip
function AnaBehDisplayAphasia(Ses);
...
for I = 1:length(ToDo),
    ...
    set(gca,'XTick',[1:2]);
    if PRINT, sub_print(F1,FigDir,Session,Sets{I}); end
    
    figure(F2);
    title([Session 'Nonwds:' Sets{I} ' ByStimulus']);
    ylabel('Percent Correct');
    xlabel('Stim Number');
    ...
    xlabel('Gram [1]; Ungram [2]');
    set(gca,'XTick',[1:2]);
    if PRINT, sub_print(F3,FigDir,Session,Sets{I}); end
    
    figure(F4);
    title([Session 'tones:' Sets{I} ' ByStimulus']);
    ylabel('Percent Correct');
    xlabel('Stim Number');
    ...
    xlabel('Gram [1]; Ungram [2]');
    set(gca,'XTick',[1:2]);
    if PRINT, sub_print(F5,FigDir,Session,Sets{I}); end
    
    figure(F6);
    title([Session 'oddball:' Sets{I} ' ByStimulus']);
    ylabel('Percent Correct');
    xlabel('Stim Number');
