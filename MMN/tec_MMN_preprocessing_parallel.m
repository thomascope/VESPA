...
parfor ss = 1:nr_sbjs,
    ...
    subjfolder = sprintf('/imaging/mlr/users/tc02/vespa/preprocess/%s/MMN+Rest',subjects{cnt});
    cd(subjfolder)
...
%     end
    ...
    for ses = 1:nr_sess
        ...
        if exist('maedfffMmmn_resp.mat','file')
            ...
            D = spm_eeg_load('edfffMmmn_resp.mat');
...
%         
        ...
        S.trialdef(2).conditionlabel = 'standard';
        S.trialdef(2).eventvalue = 15;
