...
% parameters
file2plot = 'fmcfbMdeMrun1_raw_ssst.mat';
file2plotelse = 'fmcfbMdeMrun1_1_raw_ssst.mat';
file2plot_noICA = 'fmcfbMderun1_raw_ssst.mat';
file2plotelse_noICA = 'fmcfbMderun1_1_raw_ssst.mat';
...
for m=1:length(modality)
    ...
    for s=1:length(subjects)
        ...
        figure; %new figure for each subject
        
        % load subject average with ICA
        try
        ...
        % load subject average without ICA
        try
            D = spm_eeg_load([pathstem subjects{s} '/' file2plot_noICA]);
        catch
            D = spm_eeg_load([pathstem subjects{s} '/' file2plotelse_noICA]);
        end
        times = D.time*1000;
