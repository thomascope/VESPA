...
%     workerpool.ResourceTemplate='-l nodes=^N^,mem=16GB,walltime=72:00:00';
...
%     es_preprocess_parallel('convert+epoch','maxfilter',p,pathstem,subjects{cnt},cnt,dates,blocksin,blocksout,rawpathstem,badeeg);
%    es_preprocess_parallel('convert','maxfilter',p,pathstem,subjects{cnt},cnt,dates,blocksin,blocksout,rawpathstem,badeeg);
%    es_preprocess_parallel('ICA_artifacts','convert',p,pathstem,subjects{cnt},cnt);
%    es_preprocess_parallel('definetrials','maxfilter',p,pathstem,subjects{cnt},cnt);
%    es_preprocess_parallel('epoch','ICA_artifacts',p,pathstem,subjects{cnt},cnt,dates,blocksin,blocksout,rawpathstem,badeeg);
