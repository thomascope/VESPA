function es_preprocess_parallel_ICA_templated_spm12(step,prevStep,p,pathstem,maxfilteredpathstem, subjects,subjcnt,dates,blocksin,blocksout,rawpathstem,badeeg)
...
switch prevStep
    ...
    case 'epoch'
        prevStep = 'eMrun*.mat';
    case 'merge'
        prevStep = 'c*eMrun*.mat';
    case 'rereference'
        prevStep = 'Md*eMrun*.mat';
    case 'TF_power'
        prevStep = 'tf*eMrun*.mat';
    case 'TF_phase'
        prevStep = 'tph*eMrun*.mat';
    case 'TF_rescale'
        prevStep = 'r*eMrun*.mat';
    case 'filter'
        prevStep = 'f*eMrun*.mat';
    case 'baseline'
        prevStep = 'b*eMrun*.mat';
    case 'average'
        prevStep = 'm*eMrun*.mat';
    case 'weight'
        prevStep = 'w*eMrun*.mat';
    case 'combineplanar'
        prevStep = 'p*eMrun*.mat';
    case 'artefact'
        prevStep = 'a*eMrun*.mat';
    case 'blink'
        prevStep = 'clean*eMrun*.mat';
    case 'image'
        prevStep = 'trial*eMrun*.img';
    case 'smooth'
        prevStep = 'sm*eMrun*.img';
    case 'firstlevel'
        prevStep = 't*eMrun*.img';
...
switch step
    ...
    case 'downsample' % filter data
        ...
        for s=1:size(subjects,1)
            ...
            % search for input files
            filesdone = dir(['deMrun*.mat']);    %Check if already done!
            files = dir(prevStep);
...
%                     S = [];
    ...
    case 'ICA_artifacts'
        ...
        arttopos = load('/imaging/rh01/Methods/MEGArtifactTemplateTopographies');
