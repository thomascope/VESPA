function D = resume_spm_eeg_average_TF(S)
...
%XXX added - load partly complete file
Dnew = spm_eeg_load([S.prefix fname(D)]);
...
firstzero = find(squeeze(Dnew(1,1,:,1))==0,1);
