...
inputstem = '/imaging/mlr/users/tc02/vespa/preprocess/SPM12_fullpipeline_fixedICA/testbeamforming/final_eLORETA_trunkated_restricted/';
...
outputfullpath = [outputstem 'early/'];
...
for s=1:length(controls2average) % specify file locations for batch_spm_anova_vES
    ...
    for con=1:length(conditions)
        ...
        files{1}{s}{con} = [inputstem 'early/' controls2average{s} '/uv_pow_cond_' conditions{con} '_ceffbMdMrun1_raw_ssst.nii'];
        if exist(files{1}{s}{con},'file')
        else
            files{1}{s}{con} = [inputstem 'early/' controls2average{s} '/uv_pow_cond_' conditions{con} '_ceffbMdMrun1_1_raw_ssst.nii'];
        end
...
for s=1:length(patients2average) % specify file locations for batch_spm_anova_vES
    ...
    for con=1:length(conditions)
        ...
        files{2}{s}{con} = [inputstem 'early/' patients2average{s} '/uv_pow_cond_' conditions{con} '_ceffbMdMrun1_raw_ssst.nii'];
        if exist(files{2}{s}{con},'file')
        else
            files{2}{s}{con} = [inputstem 'early/' patients2average{s} '/uv_pow_cond_' conditions{con} '_ceffbMdMrun1_1_raw_ssst.nii'];
        end
    end
...
outputfullpath = [outputstem 'late/'];
if ~exist(outputfullpath)
    mkdir(outputfullpath);
end
...
for s=1:length(controls2average) % specify file locations for batch_spm_anova_vES
    ...
    for con=1:length(conditions)
        ...
        files{1}{s}{con} = [inputstem 'late/' controls2average{s} '/uv_pow_cond_' conditions{con} '_ceffbMdMrun1_raw_ssst.nii'];
        if exist(files{1}{s}{con},'file')
        else
            files{1}{s}{con} = [inputstem 'late/' controls2average{s} '/uv_pow_cond_' conditions{con} '_ceffbMdMrun1_1_raw_ssst.nii'];
        end
...
for s=1:length(patients2average) % specify file locations for batch_spm_anova_vES
    ...
    for con=1:length(conditions)
        ...
        files{2}{s}{con} = [inputstem 'late/' patients2average{s} '/uv_pow_cond_' conditions{con} '_ceffbMdMrun1_raw_ssst.nii'];
        if exist(files{2}{s}{con},'file')
        else
            files{2}{s}{con} = [inputstem 'late/' patients2average{s} '/uv_pow_cond_' conditions{con} '_ceffbMdMrun1_1_raw_ssst.nii'];
        end
    end
...
for s=1:length(controls2average) % specify file locations for batch_spm_anova_vES
    ...
    for con=1:length(conditions)
        ...
        files{1}{s}{con} = [inputstem 'mid/' controls2average{s} '/uv_pow_cond_' conditions{con} '_ceffbMdMrun1_raw_ssst.nii'];
        if exist(files{1}{s}{con},'file')
        else
            files{1}{s}{con} = [inputstem 'mid/' controls2average{s} '/uv_pow_cond_' conditions{con} '_ceffbMdMrun1_1_raw_ssst.nii'];
        end
...
for s=1:length(patients2average) % specify file locations for batch_spm_anova_vES
    ...
    for con=1:length(conditions)
        ...
        files{2}{s}{con} = [inputstem 'mid/' patients2average{s} '/uv_pow_cond_' conditions{con} '_ceffbMdMrun1_raw_ssst.nii'];
        if exist(files{2}{s}{con},'file')
        else
            files{2}{s}{con} = [inputstem 'mid/' patients2average{s} '/uv_pow_cond_' conditions{con} '_ceffbMdMrun1_1_raw_ssst.nii'];
        end
    end
