...
save('/imaging/mlr/users/tc02/vespa/preprocess/controls_mni','controlsmni','corrected_controlsmni')
...
save('/imaging/mlr/users/tc02/vespa/preprocess/patients_mni','patientsmni','corrected_patientsmni')