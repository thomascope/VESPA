function tc_batch_source_averagetime_tf(val)

if val == 4 %there is no 4th inverse at the minute!
    return
end
...
outputstem = ['/imaging/mlr/users/tc02/vespa/preprocess/SPM12_fullpipeline/tc_source_tf1_withcorrectedMNI/reconstruction_' num2str(val) '/']; 
