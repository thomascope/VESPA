function tc_batch_source_averagetime_tf_new(val)
...
time_windows = [350 500; 520 670; 750 900];
imagetype = {
             ['cfbMdeMrun1_raw_ssst_' num2str(val) '_t350_500_f16_31*'];
             ['cfbMdeMrun1_raw_ssst_' num2str(val) '_t520_670_f16_31*'];
             ['cfbMdeMrun1_raw_ssst_' num2str(val) '_t750_900_f16_31*'];
            };
imagetype_split = {
             ['cfbMdeMrun1_1_raw_ssst_' num2str(val) '_t350_500_f16_31*'];
             ['cfbMdeMrun1_1_raw_ssst_' num2str(val) '_t520_670_f16_31*'];
