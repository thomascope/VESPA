...
for val = [5,6,7,1,2,3]
    ...
    targetfile = 'cfbMdeMrun1_raw_ssst';
    targetfilesplit = 'cfbMdeMrun1_1_raw_ssst';
    method = 'Imaging';
    ...
    for s=1:length(subjects)
        ...
        %D2 = spm_eeg_load(['/imaging/es03/P3E1/preprocess2/' subjects{s} '/' 'cfbMdeMrun1_raw_ssst.mat']); % or copy from a completely different file
        %D{s}.inv{val} = D2.inv{1};
        %D2 = spm_eeg_load(['/imaging/es03/P3E1/preprocess2_copy/' subjects{s} '/' 'cfbMdeMrun1_raw_ssst.mat']); % or copy from a completely different file
        try
            D{s}.inv{val} = D2.inv{1};
        catch
    ...
    imagetype = {
        ['cfbMdeMrun1_raw_ssst_' num2str(val) '_t90_130_f16_31*'];
        ['cfbMdeMrun1_raw_ssst_' num2str(val) '_t180_240_f16_31*'];
        ['cfbMdeMrun1_raw_ssst_' num2str(val) '_t270_420_f16_31*'];
        ['cfbMdeMrun1_raw_ssst_' num2str(val) '_t450_700_f16_31*'];
        ['cfbMdeMrun1_raw_ssst_' num2str(val) '_t750_900_f16_31*'];
        };
    imagetype_split = {
        ['cfbMdeMrun1_1_raw_ssst_' num2str(val) '_t90_130_f16_31*'];
        ['cfbMdeMrun1_1_raw_ssst_' num2str(val) '_t180_240_f16_31*'];
        ['cfbMdeMrun1_1_raw_ssst_' num2str(val) '_t270_420_f16_31*'];
        ['cfbMdeMrun1_1_raw_ssst_' num2str(val) '_t450_700_f16_31*'];
