...
%matlabbatch{2}.spm.tools.beamforming.data.dir = {'/imaging/tc02/vespa/preprocess/SPM12_fullpipeline/testbeamforming'};
...
matlabbatch{4}.spm.tools.beamforming.features.woi = [35 950];
matlabbatch{4}.spm.tools.beamforming.features.modality = {
                                                          'EEG'
                                                          'MEG'
                                                          }';
matlabbatch{4}.spm.tools.beamforming.features.fuse = 'all';
matlabbatch{4}.spm.tools.beamforming.features.plugin.csd.foi = [2 48];
...
matlabbatch{6}.spm.tools.beamforming.output.plugin.image_power.foi = [2 40];
...
matlabbatch{8}.spm.tools.beamforming.output.plugin.image_power.foi = [2 40];
