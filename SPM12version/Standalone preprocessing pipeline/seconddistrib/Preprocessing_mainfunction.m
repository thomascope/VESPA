...
switch step
    ...
    case 'ICA_artifacts'
        ...
        %ICA.PCA_EEGdim = 70;                    % ADJUST suggests PCA dim as the same as number of channels, but I find this unstable, so would suggest reducing to 50 as below. I have modified ADJUST to accept this.
        ICA.PCA_EEGdim = 50; 
