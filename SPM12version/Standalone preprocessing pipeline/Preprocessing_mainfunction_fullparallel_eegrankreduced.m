function Preprocessing_mainfunction_fullparallel_eegrankreduced(step,prevStep,p,pathstem,maxfilteredpathstem, subjects,subjcnt,dates,blocksin,blocksout,rawpathstem,badeeg,badmeg,runtodo)
...
switch step
    ...
    case 'ICA_artifacts'
        ...
        %ICA.PCA_EEGdim = 70;                    % ADJUST suggests PCA dim as the same as number of channels, but I find this unstable
        ICA.PCA_EEGdim = 50; 
        ...
        try
            ref_chans = p.refchans; %, YOU NEED TO CHANGE THIS AS APPROPRIATE FOR YOUR DATA
        catch
