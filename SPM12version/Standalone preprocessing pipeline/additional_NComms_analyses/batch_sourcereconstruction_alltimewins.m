...
function batch_sourcereconstruction_alltimewins
...
for vprime = [5]
    ...
    for timewin = 1:3
        ...
        targetfile = 'scratch_unaveraged_extract';
        targetfilesplit = targetfile;
...
%     else
%         %windows = [90 130; 180 240; 270 420; 450 700; 750 900];
%         windows = [90 150; 200 280; 290 440; 450 700; 710 860; 90 130; 180 240; 270 420; 450 700; 750 900];
%     end
%     freq = [1 40];
%
