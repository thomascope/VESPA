...
%     end
    ...
    all_random_granger_data(:,:,:,:,:,:,s) = granger_data(:,:,:,:,:,1:100); %Random permutations by trial - XXX NB: NOT IMPLEMENTED HERE, PLACEHOLDER
    ...
    if group(s) == 1
        ...
        all_random_controls_granger_data(:,:,:,:,:,:,end+1) = granger_data(:,:,:,:,:,1:100); %Random permutations by trial
    ...
    elseif group(s) == 2
        ...
        all_random_patients_granger_data(:,:,:,:,:,:,end+1) = granger_data(:,:,:,:,:,1:100); %Random permutations by trial
