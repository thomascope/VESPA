...
for n = 1:21
    ...
    foi = foi(2:end);
    save([outdir 's' num2str(s) '_grangerdata_highfreq_' num2str(start_times) '_' num2str(end_times) '_z' num2str(n)],'bipolar_labels','corr_sig_pairs','temp_granger_data','start_times','end_times','foi');
end
%% save results
...
for z = 1:21
    ...
    load ([outdir 's' num2str(s) '_grangerdata_highfreq_' num2str(start_times) '_' num2str(end_times) '_z' num2str(z)])
...
save([outdir 's' num2str(s) '_grangerdata_highfreq_' num2str(start_times) '_' num2str(end_times) '_overall'],'bipolar_labels','corr_sig_pairs','granger_data','start_times','end_times','foi');
