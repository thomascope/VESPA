...
%for time = 1
    ...
    elseif time == 2
        ...
        outdir = [pathstem 'extractedsources_tf_newbaseline/'];
        start_times = 32;
        end_times = 944;
    else
        ...
        outdir = [pathstem 'extractedsources_tf_null/'];
        start_times = -968;
        end_times = -56;
    end
...
%     %end
    ...
    parallel_tec_granger_source_coherence_unaveraged_tf(s,outdir,start_times,end_times,fft_method,method)
end