...
function plot_betas_tf_thresholded(plot_threshold,whichbetas,contrast,statspm,nsubj,frequency,modality,varargin)
...
for i = 1:length(varargin)
    fieldtrip_topoplot_highlight_tf_thresholded(varargin{i},contrastnumber,frequency,modality,plot_threshold)
end