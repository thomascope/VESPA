...
function plot_betas_tf_newbaseline(whichbetas,contrast,statspm,nsubj,frequency,modality,varargin)
pathstem = ['/imaging/mlr/users/tc02/vespa/preprocess/SPM12_fullpipeline_fixedICA/stats_tf_newbaseline_shortenedsm_/combined_-100_1000_' modality];
...
figure
plot(-100:4:1000,controltoplot(101:376),'g','LineWidth',4)
hold on
...
plot(-100:4:1000,patienttoplot(101:376),'r','LineWidth',4)
plot(-100:4:1000,zeros(1,length([-100:4:1000])),'k-')
xlim([-400 2380])

% threshold=tinv(0.95,(nsubj-2));
threshold = 4.24; %F-height threshold in SPM for main effect of group
...
jbfill(-100:4:1000,controltoplot(101:376),patienttoplot(101:376),allsigs(101:376)','r','none',[],0.5);
...
for i = 1:length(varargin)
    fieldtrip_topoplot_highlight_tf_newbaseline(varargin{i},contrastnumber,frequency,modality)
end