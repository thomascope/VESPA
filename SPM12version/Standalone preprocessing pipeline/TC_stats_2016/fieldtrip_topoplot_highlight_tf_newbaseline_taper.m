...
function fieldtrip_topoplot_highlight_tf_newbaseline_taper(timewindow,contrastnumber,frequency,modality)

timewindow = timewindow/1000; %time window input in ms, but fieldtrip needs it in seconds

data{1} = spm_eeg_load('/imaging/mlr/users/tc02/vespa/preprocess/SPM12_fullpipeline_tf_newbaseline_fixedICA_newbaseline_taper/meg14_0072_vc1/controls_weighted_grandmean.mat');
data{2} = spm_eeg_load('/imaging/mlr/users/tc02/vespa/preprocess/SPM12_fullpipeline_tf_newbaseline_fixedICA_newbaseline_taper/meg14_0085_vp1/patients_weighted_grandmean.mat');
...
if strcmp(modality,'MEGPLANAR') || strcmp(modality,'MEGCOMB')
    ...
    figure(controlfig)
    save_string = ['./Significant_peaks/Controls topoplot for planar gradiometers, contrast ' num2str(contrastnumber) ' time window ' num2str(timewindow(1)) ' to ' num2str(timewindow(2)) ' at ' num2str(frequency) ' Hz.png'];
    eval(['export_fig ''' save_string ''' -transparent'])
    close(controlfig)
    figure(patientfig)
    save_string = ['./Significant_peaks/Patients topoplot for planar gradiometers, contrast ' num2str(contrastnumber) ' time window ' num2str(timewindow(1)) ' to ' num2str(timewindow(2)) ' at ' num2str(frequency) ' Hz.png'];
    eval(['export_fig ''' save_string ''' -transparent'])
    close(patientfig)
...
elseif strcmp(modality,'MEGMAG') || strcmp(modality,'MEG')
    ...
    figure(controlfig)
    save_string = ['./Significant_peaks/Controls topoplot for magnetometers, contrast ' num2str(contrastnumber) ' time window ' num2str(timewindow(1)) ' to ' num2str(timewindow(2)) ' at ' num2str(frequency) ' Hz.png'];
    eval(['export_fig ''' save_string ''' -transparent'])
    close(controlfig)
    figure(patientfig)
    save_string = ['./Significant_peaks/Patients topoplot for magnetometers, contrast ' num2str(contrastnumber) ' time window ' num2str(timewindow(1)) ' to ' num2str(timewindow(2)) ' at ' num2str(frequency) ' Hz.png'];
    eval(['export_fig ''' save_string ''' -transparent'])
    close(patientfig)
...
elseif strcmp(modality,'EEG')
    ...
    figure(controlfig)
    save_string = ['./Significant_peaks/Controls topoplot for EEG, contrast ' num2str(contrastnumber) ' time window ' num2str(timewindow(1)) ' to ' num2str(timewindow(2)) ' at ' num2str(frequency) ' Hz.png'];
    eval(['export_fig ''' save_string ''' -transparent'])
    close(controlfig)
    figure(patientfig)
    save_string = ['./Significant_peaks/Patients topoplot for EEG, contrast ' num2str(contrastnumber) ' time window ' num2str(timewindow(1)) ' to ' num2str(timewindow(2)) ' at ' num2str(frequency) ' Hz.png'];
    eval(['export_fig ''' save_string ''' -transparent'])
    close(patientfig)
end
