...
function fieldtrip_topoplot_highlight_tf_thresholded(timewindow,contrastnumber,frequency,modality,threshold)
...
if strcmp(modality,'MEGPLANAR') || strcmp(modality,'MEGCOMB')
    ...
    figure(controlfig)
    save_string = ['./Significant_peaks/Controls topoplot for planar gradiometers, contrast ' num2str(contrastnumber) ' time window ' num2str(timewindow(1)) ' to ' num2str(timewindow(2)) ' at ' num2str(frequency) ' Hz'];
    ...
    figure(patientfig)
    save_string = ['./Significant_peaks/Patients topoplot for planar gradiometers, contrast ' num2str(contrastnumber) ' time window ' num2str(timewindow(1)) ' to ' num2str(timewindow(2)) ' at ' num2str(frequency) ' Hz'];
    eval(['export_fig ''' save_string '.pdf'' -transparent'])
    ch=findall(gcf,'Interpreter','tex');
    delete(ch)
    ch=findall(gcf,'tag','Colorbar');
...
elseif strcmp(modality,'MEGMAG') || strcmp(modality,'MEG')
    ...
    figure(controlfig)
    save_string = ['./Significant_peaks/Controls topoplot for magnetometers, contrast ' num2str(contrastnumber) ' time window ' num2str(timewindow(1)) ' to ' num2str(timewindow(2)) ' at ' num2str(frequency) ' Hz'];
    eval(['export_fig ''' save_string '.pdf'' -transparent'])
    ch=findall(gcf,'Interpreter','tex');
    delete(ch)
    ch=findall(gcf,'tag','Colorbar');
    ...
    figure(patientfig)
    save_string = ['./Significant_peaks/Patients topoplot for magnetometers, contrast ' num2str(contrastnumber) ' time window ' num2str(timewindow(1)) ' to ' num2str(timewindow(2)) ' at ' num2str(frequency) ' Hz'];
   eval(['export_fig ''' save_string '.pdf'' -transparent'])
    ch=findall(gcf,'Interpreter','tex');
    delete(ch)
    ch=findall(gcf,'tag','Colorbar');
...
elseif strcmp(modality,'EEG')
    ...
    figure(controlfig)
    save_string = ['./Significant_peaks/Controls topoplot for EEG, contrast ' num2str(contrastnumber) ' time window ' num2str(timewindow(1)) ' to ' num2str(timewindow(2)) ' at ' num2str(frequency) ' Hz'];
   eval(['export_fig ''' save_string '.pdf'' -transparent'])
    ch=findall(gcf,'Interpreter','tex');
    delete(ch)
    ch=findall(gcf,'tag','Colorbar');
    ...
    figure(patientfig)
    save_string = ['./Significant_peaks/Patients topoplot for EEG, contrast ' num2str(contrastnumber) ' time window ' num2str(timewindow(1)) ' to ' num2str(timewindow(2)) ' at ' num2str(frequency) ' Hz'];
    eval(['export_fig ''' save_string '.pdf'' -transparent'])
    ch=findall(gcf,'Interpreter','tex');
    delete(ch)
    ch=findall(gcf,'tag','Colorbar');
