function output = search_subfunction(x(1), x(2))
%
...
global vocode_report_4_patient vocode_report_8_patient vocode_report_16_patient
...
differences = normalised_model_meansarray - meansarray;
