function output = search_subfunction_patient_mod(x)
% 
...
global vocode_report_4_patient vocode_report_8_patient vocode_report_16_patient patnum mu_input_match mu_input_mismatch mu_pred meansarray
    ...
    sigma_input = 10*mu_input_match/vocode_report_4_patient(patnum);
    %mu_pred_ovr = (sigma_input^2/(x(1)^2+sigma_input^2))*mu_pred + (x(1)^2/(x(1)^2+sigma_input^2))*mu_input;
    sigma_pred_ovr = (1/x(1)^2 + 1/sigma_input^2)^-0.5+x(2)*abs(mu_pred-mu_input);
    Pred_total = ((1/(sigma_pred_ovr*sqrt(2*pi))));    
    ...
    mu_input = mu_input_match;
    sigma_input = 10*mu_input_match/vocode_report_8_patient(patnum);
    mu_input = mu_input_match;
    mu_pred_ovr = (sigma_input^2/(x(1)^2+sigma_input^2))*mu_pred + (x(1)^2/(x(1)^2+sigma_input^2))*mu_input;
    sigma_pred_ovr = (1/x(1)^2 + 1/sigma_input^2)^-0.5+x(2)*abs(mu_pred-mu_input);
    Pred_total = ((1/(sigma_pred_ovr*sqrt(2*pi))));    
    ...
    mu_input = mu_input_match;    
    sigma_input = 10*mu_input_match/vocode_report_16_patient(patnum);
    mu_input = mu_input_match;
    mu_pred_ovr = (sigma_input^2/(x(1)^2+sigma_input^2))*mu_pred + (x(1)^2/(x(1)^2+sigma_input^2))*mu_input;
    sigma_pred_ovr = (1/x(1)^2 + 1/sigma_input^2)^-0.5+x(2)*abs(mu_pred-mu_input);
    Pred_total = ((1/(sigma_pred_ovr*sqrt(2*pi))));    
    ...
    sigma_input = 10*mu_input_mismatch/vocode_report_4_patient(patnum);   
    mu_pred_ovr = (sigma_input^2/(x(1)^2+sigma_input^2))*mu_pred + (x(1)^2/(x(1)^2+sigma_input^2))*mu_input;
    sigma_pred_ovr = (1/x(1)^2 + 1/sigma_input^2)^-0.5+x(2)*abs(mu_pred-mu_input);
    Pred_total = ((1/(sigma_pred_ovr*sqrt(2*pi))));    
    ...
    mu_input = mu_input_mismatch;
    sigma_input = 10*mu_input_mismatch/vocode_report_8_patient(patnum);   
    mu_pred_ovr = (sigma_input^2/(x(1)^2+sigma_input^2))*mu_pred + (x(1)^2/(x(1)^2+sigma_input^2))*mu_input;
    sigma_pred_ovr = (1/x(1)^2 + 1/sigma_input^2)^-0.5+x(2)*abs(mu_pred-mu_input);
    Pred_total = ((1/(sigma_pred_ovr*sqrt(2*pi))));    
    ...
    mu_input = mu_input_mismatch;
    sigma_input = 10*mu_input_mismatch/vocode_report_16_patient(patnum);   
    mu_pred_ovr = (sigma_input^2/(x(1)^2+sigma_input^2))*mu_pred + (x(1)^2/(x(1)^2+sigma_input^2))*mu_input;
    sigma_pred_ovr = (1/x(1)^2 + 1/sigma_input^2)^-0.5+x(2)*abs(mu_pred-mu_input);
    Pred_total = ((1/(sigma_pred_ovr*sqrt(2*pi))));    
