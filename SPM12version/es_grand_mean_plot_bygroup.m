...
% parameters
patientfile2plot = '/imaging/tc02/vespa/preprocess/SPM12_fullpipeline_newICA/Grand Averages/patients_weighted_grandmean.mat';
controlfile2plot = '/imaging/tc02/vespa/preprocess/SPM12_fullpipeline_newICA/Grand Averages/controls_weighted_grandmean.mat';
...
barweb(reshape(patientnanmeans,2,4)',reshape(patientsems,2,4)',[],{'90-130ms'; '180-240ms'; '270-420ms'; '450-700ms'},['Patient nanmeans by timewindow '],[],'fT',[],[],{'Match','Mismatch'}) ;
legend('Match','Mismatch','location','NorthWest');
set(gca,'YDir','Reverse');

figure
set(gcf,'position',[100,100,1200,800])
barweb(reshape(controlnanmeans,2,4)',reshape(controlsems,2,4)',[],{'90-130ms'; '180-240ms'; '270-420ms'; '450-700ms'},['Control nanmeans by timewindow '],[],'fT',[],[],{'Match','Mismatch'}) ;
legend('Match','Mismatch','location','NorthWest');
set(gca,'YDir','Reverse');
