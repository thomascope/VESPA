...
parfor cnt = 1:size(subjects,2)
   ...
   %es_preprocess_parallel_ICA_spm12('definetrials','maxfilter',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
   ...
   %need to use SPM8 version for this or define after conversion.
      ...
      %es_preprocess_parallel_ICA_spm12('convert+epoch','maxfilter',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt,dates,blocksin,blocksout,rawpathstem, maxfilteredpathstembadeeg);
   es_preprocess_parallel_ICA_spm12('convert','maxfilter',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt,dates,blocksin,blocksout,rawpathstem, badeeg)
   es_preprocess_parallel_ICA_spm12('ICA_artifacts','convert',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
   es_preprocess_parallel_ICA_spm12('definetrials','maxfilter',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
   es_preprocess_parallel_ICA_spm12('epoch','ICA_artifacts',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt,dates,blocksin,blocksout,rawpathstem, badeeg);
    es_preprocess_parallel_ICA_spm12('downsample','epoch',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
    es_preprocess_parallel_ICA_spm12('rereference','downsample',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
    es_preprocess_parallel_ICA_spm12('baseline','rereference',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
    es_preprocess_parallel_ICA_spm12('filter','baseline',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
    es_preprocess_parallel_ICA_spm12('merge','filter',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
    es_preprocess_parallel_ICA_spm12('sort','merge',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
    es_preprocess_parallel_ICA_spm12('average','merge',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
    es_preprocess_parallel_ICA_spm12('filter','average',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
    
    %es_preprocess_parallel_ICA_spm12('combineplanar','fm*.mat',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
   % es_preprocess_parallel_ICA_spm12('grand_average','pcfm*.mat',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
    
    %es_preprocess_parallel_ICA_spm12('weight','pcfm*.mat',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
    %es_preprocess_parallel_ICA_spm12('grand_average','wpcfm*.mat',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
    
    %es_preprocess_parallel_ICA_spm12('image','cfm*.mat',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
    %es_preprocess_parallel_ICA_spm12('image','wpcfm*.mat',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
    %es_preprocess_parallel_ICA_spm12('smooth','image',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
    %es_preprocess_parallel_ICA_spm12('firstlevel','smooth',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
    
    %es_preprocess_parallel_ICA_spm12('mask','image',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
    
    %% Other preprocessing steps
    %es_preprocess_parallel_ICA_spm12('artefact','baseline',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
    %es_preprocess_parallel_ICA_spm12('sort','average',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
    %es_preprocess_parallel_ICA_spm12('erase','',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
    %p.outputstem = '/imaging/es03/P6E1/preprocess_TF/'; % for copying files
    %es_preprocess_parallel_ICA_spm12('copy','rereference',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
