function [remove,weights,TraMat,ICs,datacor,varexpl] = remove_ICA_artefacts_short(d,refs,PCA_dim,Nperm,CorThr,VarThr,FiltPars);
% Shortened to have 80 ICs for faster processing.
