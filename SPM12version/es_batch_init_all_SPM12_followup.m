...
% 
cnt = cnt + 1;
subjects{cnt}.oldname = 'meg14_0072_vc1';
subjects{cnt}.newname = 'meg14_0072_vc1_fup';
dates{cnt} = '160505';
...
%the buttons
cnt = cnt + 1;
subjects{cnt}.oldname = 'meg14_0085_vp1';
subjects{cnt}.newname = 'meg14_0085_vp1_fup';
dates{cnt} = '160428';
...
% 
cnt = cnt + 1;
subjects{cnt}.oldname = 'meg14_0087_vp2';
subjects{cnt}.newname = 'meg14_0087_vp2_fup';
dates{cnt} = '160411';
...
cnt = cnt + 1;
subjects{cnt}.oldname = 'meg14_0093_vc2';
subjects{cnt}.newname = 'meg14_0093_vc2_fup';
dates{cnt} = '160404';
...
% 
% cnt = cnt + 1;
% subjects{cnt}.oldname = 'meg14_0096_vc3';
% dates{cnt} = '140307';
...
% % cnt = cnt + 1;
% % subjects{cnt}.newname = 'meg14_0104_vp3';
% % dates{cnt} = '140310';
% % blocksin{cnt} = {'vespa_first', 'vespa_second', 'vespa_third'};
% % blocksout{cnt} = {'run1', 'run2', 'run3'};
% % badchannels{cnt, 1} = {'0813','1222','1223','0521','0342','2141','1731','2143'}; badchannels{cnt, 2} = {'0813','1222','1223','0521','0342','2141','1731','2143'}; badchannels{cnt, 3} = {'0813','1222','1223','0521','0342','2141','1731','2143'}; badchannels{cnt, 4} = {'0813','1222','1223','0521','0342','2141','1731','2143'}; badchannels{cnt, 5} = {'0813','1222','1223','0521','0342','2141','1731','2143'}; badchannels{cnt, 6} = {}; badchannels{cnt, 7} = {}; % define bad MEG (not EEG) channels here (if there are any)
...
% 
cnt = cnt + 1;
subjects{cnt}.oldname = 'meg14_0114_vc4';
subjects{cnt}.newname = 'meg14_0114_vc4_fup';
dates{cnt} = '160405';
blocksin{cnt} = {'vespa_fup_first', 'vespa_fup_second','vespa_fup_third'};  % vespa_fup_rest; vespa_fup_MMN
blocksout{cnt} = {'run1', 'run2','run3'};
badchannels{cnt, 1} = {'0813'}; badchannels{cnt, 2} = {'0813'}; badchannels{cnt, 3} = {'0813'}; badchannels{cnt, 4} = {'0813'}; badchannels{cnt, 5} = {'0813'}; badchannels{cnt, 6} = {}; badchannels{cnt, 7} = {}; % define bad MEG (not EEG) channels here (if there are any)
...
% 
cnt = cnt + 1;
subjects{cnt}.oldname = 'meg14_0121_vp5';
subjects{cnt}.newname = 'meg14_0121_vp5_fup';
dates{cnt} = '160509';
...
% cnt = cnt + 1;
% subjects{cnt}.oldname = 'meg16_0103_vc5';
% dates{cnt} = '160523';
...
% 
cnt = cnt + 1;
subjects{cnt}.newname = 'meg14_0130_vp6_fup';
subjects{cnt}.oldname = 'meg14_0130_vp6';
dates{cnt} = '160412';
...
% 
% cnt = cnt + 1;
% subjects{cnt}.newname = 'meg14_0135_vp7';
% dates{cnt} = '140325';
% blocksin{cnt} = {'vespa_first', 'vespa_second','vespa_third'};
% blocksout{cnt} = {'run1', 'run2','run3'};
% badchannels{cnt, 1} = {'0813','1731','1412','1921'}; badchannels{cnt, 2} = {'0813','1731','1412','1921'}; badchannels{cnt, 3} = {'0813','1731','1412','1921'}; badchannels{cnt, 4} = {'0813','1731','1412','1921'}; badchannels{cnt, 5} = {'0813','1731','1412','1921'}; badchannels{cnt, 6} = {}; badchannels{cnt, 7} = {}; % define bad MEG (not EEG) channels here (if there are any)
...
% 
cnt = cnt + 1;
subjects{cnt}.oldname = 'meg14_0140_vc6';
subjects{cnt}.newname = 'meg14_0140_vc6_fup';
dates{cnt} = '160422';
blocksin{cnt} = {'vespa_fup_first', 'vespa_fup_second','vespa_fup_third'};  % vespa_fup_rest; vespa_fup_MMN
blocksout{cnt} = {'run1', 'run2','run3'};
badchannels{cnt, 1} = {'0813'}; badchannels{cnt, 2} = {'0813'}; badchannels{cnt, 3} = {'0813'}; badchannels{cnt, 4} = {'0813'}; badchannels{cnt, 5} = {'0813'}; badchannels{cnt, 6} = {}; badchannels{cnt, 7} = {}; % define bad MEG (not EEG) channels here (if there are any)
...
%Breathing artifact
cnt = cnt + 1;
subjects{cnt}.oldname = 'meg14_0434_vc7';
subjects{cnt}.newname = 'meg14_0434_vc7_fup';
dates{cnt} = '160429';
blocksin{cnt} = {'vespa_fup_first', 'vespa_fup_second','vespa_fup_third','vespa_fup_nobuttons'}; % vespa_fup_rest; vespa_fup_MMN
blocksout{cnt} = {'run1', 'run2','run3','nobuttons'};
...
% 
% cnt = cnt + 1;
% subjects{cnt}.oldname = 'meg14_0150_vp8';
% dates{cnt} = '140403';
...
% 
cnt = cnt + 1;
subjects{cnt}.newname = 'meg14_0184_vp9_fup';
subjects{cnt}.oldname = 'meg14_0814_vp9'; %Note typo transposition of MEG number
dates{cnt} = '160408';
...
% 
cnt = cnt + 1;
subjects{cnt}.newname = 'meg14_0205_vp10_fup';
subjects{cnt}.oldname = 'meg14_0205_vp10';
dates{cnt} = '160425';
...
% 
cnt = cnt + 1;
subjects{cnt}.newname = 'meg14_0506_vp12_fup';
subjects{cnt}.oldname = 'meg16_0216_vp12'; %note odd subject designation 
dates{cnt} = '160421';
blocksin{cnt} = {'vespa_fup_first', 'vespa_fup_second','vespa_fup_third'}; % vespa_fup_rest; vespa_fup_MMN
blocksout{cnt} = {'run1', 'run2','run3'};
...
% % cnt = cnt + 1;
% % subjects{cnt}.newname = 'meg14_0209_vc8';
% % dates{cnt} = '140508';
% % blocksin{cnt} = {'vespa_first', 'vespa_second','vespa_third'}; 
% % blocksout{cnt} = {'run1', 'run2','run3'};
% % badchannels{cnt, 1} = {'0813','1731','1412'}; badchannels{cnt, 2} = {'0813','1731','1412'}; badchannels{cnt, 3} = {'0813','1731','1412'}; badchannels{cnt, 4} = {'0813','1731','1412'}; badchannels{cnt, 5} = {'0813','1731','1412'}; badchannels{cnt, 6} = {'0813','1731','1412'}; badchannels{cnt, 7} = {}; % define bad MEG (not EEG) channels here (if there are any)
...
% 
cnt = cnt + 1;
subjects{cnt}.oldname = 'meg14_0218_vc9';
subjects{cnt}.newname = 'meg14_0218_vc9_fup';
dates{cnt} = '160513';
blocksin{cnt} = {'vespa_fup_first', 'vespa_fup_second','vespa_fup_third','vespa_fup_nobuttons'}; % vespa_fup_rest; vespa_fup_MMN
blocksout{cnt} = {'run1', 'run2','run3','nobuttons'};
...
% 
% cnt = cnt + 1;
% subjects{cnt}.oldname = 'meg14_0222_vp11'; %NB: VP12 and VP11 done out of sequence
% dates{cnt} = '140513';
% blocksin{cnt} = {'vespa_first', 'vespa_second','vespa_third'}; 
% blocksout{cnt} = {'run1', 'run2','run3'};
% badchannels{cnt, 1} = {'0813','1731','0922','2343'}; badchannels{cnt, 2} = {'0813','1731','0922','2343'}; badchannels{cnt, 3} = {'0813','1731','0922','2343'}; badchannels{cnt, 4} = {'0813','1731','0922','2343'}; badchannels{cnt, 5} = {'0813','1731','0922','2343'}; badchannels{cnt, 6} = {'0813','1731','0922','2343'}; badchannels{cnt, 7} = {}; % define bad MEG (not EEG) channels here (if there are any)
...
% 
cnt = cnt + 1;
subjects{cnt}.newname = 'meg14_0234_vc10_fup';
subjects{cnt}.oldname = 'meg14_0234_vc10';
dates{cnt} = '160526';
blocksin{cnt} = {'vespa_fup_first', 'vespa_fup_second','vespa_fup_third','vespa_fup_nobuttons'};  % vespa_fup_rest; vespa_fup_MMN
blocksout{cnt} = {'run1', 'run2','run3','nobuttons'};
...
% 
cnt = cnt + 1;
subjects{cnt}.newname = 'meg14_0242_vc11_fup';
subjects{cnt}.oldname = 'meg14_0242_vc11';
dates{cnt} = '160531';
blocksin{cnt} = {'vespa_fup_first', 'vespa_fup_second','vespa_fup_third','vespa_fup_nobuttons'};  % vespa_fup_rest; vespa_fup_MMN
blocksout{cnt} = {'run1', 'run2','run3','nobuttons'};
...
% 
cnt = cnt + 1;
subjects{cnt}.newname = 'meg14_0253_vc12_fup';
subjects{cnt}.oldname = 'meg14_0253_vc12';
dates{cnt} = '160503';
blocksin{cnt} = {'vespa_fup_first', 'vespa_fup_second','vespa_fup_third','vespa_fup_nobuttons'};  % vespa_fup_rest; vespa_fup_MMN
blocksout{cnt} = {'run1', 'run2','run3','nobuttons'};
badchannels{cnt, 1} = {'0813','0333'}; badchannels{cnt, 2} = {'0813','0333'}; badchannels{cnt, 3} = {'0813','0333'}; badchannels{cnt, 4} = {'0813','0333'}; badchannels{cnt, 5} = {'0813','0333'}; badchannels{cnt, 6} = {'0813','0333'}; badchannels{cnt, 7} = {}; % define bad MEG (not EEG) channels here (if there are any)
