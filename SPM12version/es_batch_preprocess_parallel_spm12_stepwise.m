...
parfor cnt = 1:size(subjects,2)
    %es_preprocess_parallel_ICA_spm12('definetrials','convert',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt);
   es_preprocess_parallel_ICA_spm12('epoch','convert',p,pathstem, maxfilteredpathstem, subjects{cnt},cnt,dates,blocksin,blocksout,rawpathstem, badeeg);
end
parfor cnt = 1:size(subjects,2)
